...
export const common = defineMessages({
  zh: {
    ...
    "common.sourceSpan.openInSources": "在来源页打开",
    "common.sourceSpan.metadata.occurredOn": "来源日期",
  ...
  en: {
    ...
    "common.gate.aria": "Citation gate counts",
    ...
    "common.sourceSpan.metadata.occurredOn": "Source date",
