...
This library holds one long-running two-person conversation: **Joanna** and **Nate**, talking
across 29 sessions between 21 January 2022 – 11 November 2022. The material arrives one session at a time and
...
Joanna's side of it runs through writing and a project she is working on, reading, film (drama and romantic comedy), nature; a favourite film she first watched about three years ago and owns on disc.
Nate's side runs through competitive video gaming (a first tournament win in Counter-Strike: Global Offensive), action and sci-fi film.
Recurring named things to expect: the films and games named on either side; the tournament; Joanna's writing project.
...
**`people/{slug}.md`** — one page per person. Joanna and Nate each have one from the start.
...
who they are, how they relate to Joanna or Nate, and the facts that belong to *them* — their job,
...
Worth it, in this material: a title named, plus how it entered their life (recommended by whom, watched when, owned in what form); a tournament result with the game and the date; a milestone in Joanna's writing project; a recommendation one made to the other and whether it was taken up.

Not worth it: taste declared with no title attached; "sounds cool, I'll check it out" with no follow-through.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Joanna, Nate, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Joanna's job stated by Joanna is direct; the same fact relayed by
Nate is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Joanna shared
