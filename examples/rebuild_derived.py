...
Usage:
    ...
    uv run python examples/rebuild_derived.py u-opc-lin
    uv run python examples/rebuild_derived.py --all        # every user with canonical/L0
...
from reindex_l2 import _chunks_for  # shared L2 chunk dispatch (mirrors a fresh ingest)
