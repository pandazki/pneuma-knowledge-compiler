...
This library holds one long-running two-person conversation: **Audrey** and **Andrew**, talking
across 28 sessions between 27 March 2023 – 22 November 2023. The material arrives one session at a time and
...
Audrey's side of it runs through three dogs — Pepper, Precious and Panda, hers for three years — and the city parks and trails she explores with them.
Andrew's side runs through a new job as a Financial Analyst started shortly before the first session, birds (eagles above all), and hiking (Fox Hollow at weekends).
Recurring named things to expect: Pepper, Precious and Panda; Fox Hollow and the other named trails and parks.
...
**`people/{slug}.md`** — one page per person. Audrey and Andrew each have one from the start.
...
who they are, how they relate to Audrey or Andrew, and the facts that belong to *them* — their job,
...
Worth it, in this material: which dog is which and what is true of each one specifically; a job start, change or milestone with its date; a named trail, park or outing and when it happened; a purchase for the dogs and roughly when.

Not worth it: "cute!"; generic animal appreciation; the same fondness restated.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Audrey, Andrew, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Audrey's job stated by Audrey is direct; the same fact relayed by
Andrew is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Audrey shared
