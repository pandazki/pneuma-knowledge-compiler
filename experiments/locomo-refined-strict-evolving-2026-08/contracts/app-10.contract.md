...
This library holds one long-running two-person conversation: **Calvin** and **Dave**, talking
across 30 sessions between 23 March 2023 – 17 November 2023. The material arrives one session at a time and
...
Calvin's side of it runs through a new mansion, a stay in Japan arranged by his agent (leaving the month after the first session, staying some months, then on to Boston), Japanese culture, and collaborations with local musicians.
Dave's side runs through classic cars and car shows, and a park with a lake he spends time at.
Recurring named things to expect: the mansion and the Japanese lodging (two distinct places); the named parks and car shows; the musical collaborations.
...
**`people/{slug}.md`** — one page per person. Calvin and Dave each have one from the start.
...
who they are, how they relate to Calvin or Dave, and the facts that belong to *them* — their job,
...
Worth it, in this material: a move, a trip or a stay with its dates and its destination; who arranged what; a collaboration with the musician named and what came of it; a show attended with its date; a purchase of consequence.

Not worth it: travel excitement with no itinerary fact; generic admiration of a photo.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Calvin, Dave, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Calvin's job stated by Calvin is direct; the same fact relayed by
Dave is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Calvin shared
