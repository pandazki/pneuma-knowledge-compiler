...
This library holds one long-running two-person conversation: **Tim** and **John**, talking
across 29 sessions between 21 May 2023 – 12 January 2024. The material arrives one session at a time and
...
Tim's side of it runs through a Harry Potter fan project and the collaborations around it, a London trip to a Potter site some years back.
John's side runs through signing with the Minnesota Wolves as a shooting guard, a season opener, working on his shooting percentage, fitting into a new team, a sneaker collection.
Recurring named things to expect: the fan project; the Minnesota Wolves; named games and venues; the sneaker collection.
...
**`people/{slug}.md`** — one page per person. Tim and John each have one from the start.
...
who they are, how they relate to Tim or John, and the facts that belong to *them* — their job,
...
Worth it, in this material: a signing, a game, or a season milestone with its date and the opponent or result; a stated training goal and any later measurement of it; a step in the fan project (who joined, what was decided, what shipped); a place visited with roughly when.

Not worth it: pre-game excitement carrying no fact; compliments; repeated statements of enthusiasm for the same thing.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Tim, John, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Tim's job stated by Tim is direct; the same fact relayed by
...
description of what the speaker showed, attributed to the speaker who shared it — "Tim shared
