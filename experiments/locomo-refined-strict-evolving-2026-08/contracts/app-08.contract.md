...
This library holds one long-running two-person conversation: **Deborah** and **Jolene**, talking
across 30 sessions between 23 January 2023 – 20 September 2023. The material arrives one session at a time and
...
Deborah's side of it runs through her mother, who died some years ago, the mother's old house and the bench by its window, a pendant she keeps, and teaching yoga in her community.
Jolene's side runs through electrical engineering work, her mother who died the previous year, and a pendant her mother gave her in Paris in 2010 whose symbol stands for freedom.
Recurring named things to expect: each woman's pendant (they are two different pendants); the mother's house and its bench; the yoga classes; Jolene's engineering projects.
...
**`people/{slug}.md`** — one page per person. Deborah and Jolene each have one from the start.
...
who they are, how they relate to Deborah or Jolene, and the facts that belong to *them* — their job,
...
Worth it, in this material: which keepsake belongs to whom, who gave it, where and in what year; a death, a visit or an anniversary with its date; a class taught or a project finished with its date; the reason someone gives for a practice they keep.

Not worth it: condolences; shared sentiment with no fact; comfort offered without new information.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Deborah, Jolene, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Deborah's job stated by Deborah is direct; the same fact relayed by
Jolene is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Deborah shared
