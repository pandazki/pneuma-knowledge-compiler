...
export const lens = defineMessages({
  zh: {
    ...
    "lens.metric.lead_over_even": "首位主体对均分的倍率",
    "lens.metric.heaviest_family_ratio": "最重族的断言／页数倍率",
    "lens.metric.empty_families": "零页的族",
    "lens.metric.clusters": "簇数",

    "lens.metric.narration_share": "会话叙述断言占比",
    "lens.metric.log_subject_share": "以流水为主的主体占比",
    "lens.metric.lead_family_claim_share": "首位族的断言占比",

    "lens.metric.supersessions_per_100_claims": "每百条断言的取代数",
    "lens.metric.rollovers": "分卷次数",
    "lens.metric.overview_coverage": "有概览的主体占比",
    "lens.metric.untouched_subject_share": "建成后未再写过的主体占比",
    "lens.metric.median_days_since_write": "距上次写入天数中位数",

    "lens.metric.dated_outside_chronology_share": "编年族之外的带日期断言占比",
    "lens.metric.decision_shaped_outside_share": "决策族之外的决策段落占比",
    "lens.metric.empty_family_share": "零页族占比",

    "lens.metric.consultations": "咨询次数",
    "lens.metric.uncited_share": "无引用作答占比",
    "lens.metric.consulted_subject_share": "被问过的主体占比",
    "lens.metric.lead_family_demand_ratio": "首位族的问答／断言倍率",
  ...
  en: {
    ...
    "lens.metric.lead_over_even": "Lead subject over an even share",
    "lens.metric.heaviest_family_ratio": "Heaviest family's claims per page",
    ...
    "lens.metric.log_subject_share": "Subjects that read as a log",
    "lens.metric.lead_family_claim_share": "Lead family's claim share",

    "lens.metric.supersessions_per_100_claims": "Supersessions per 100 claims",
    "lens.metric.rollovers": "Rollovers",
    "lens.metric.overview_coverage": "Subjects with an overview",
    "lens.metric.untouched_subject_share": "Subjects never written since creation",
    "lens.metric.median_days_since_write": "Median days since last write",

    "lens.metric.dated_outside_chronology_share": "Dated claims outside a chronology",
    "lens.metric.decision_shaped_outside_share": "Decision sections outside the decisions family",
    "lens.metric.empty_family_share": "Declared families with no page, as a share",

    "lens.metric.consultations": "Consultations",
    "lens.metric.uncited_share": "Answers with no citation",
    "lens.metric.consulted_subject_share": "Subjects consulted",
    "lens.metric.lead_family_demand_ratio": "Lead family's questions per claim",
