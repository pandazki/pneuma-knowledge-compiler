...
This library holds one long-running two-person conversation: **Caroline** and **Melanie**, talking
across 19 sessions between 8 May 2023 – 22 October 2023. The material arrives one session at a time and
...
Caroline's side of it runs through an LGBTQ support group and what it changed for her, self-acceptance, continuing her education, and a move toward counselling / mental-health work.
Melanie's side runs through raising kids alongside a demanding job, painting as her outlet (a lake-sunrise canvas she painted the year before), swimming with the kids.
Recurring named things to expect: Melanie's lake-sunrise painting; the support group itself.
...
**`people/{slug}.md`** — one page per person. Caroline and Melanie each have one from the start.
...
who they are, how they relate to Caroline or Melanie, and the facts that belong to *them* — their job,
...
Worth it, in this material: Caroline saying which career direction she is now pursuing and why; Melanie naming when she painted a particular canvas; a support-group session attended on a stated day and what came out of it; either woman's stated feeling about a concrete event (it is the substance of this friendship, not small talk).

Not worth it: greetings and sign-offs; "good to see you"; generic encouragement that carries no fact.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Caroline, Melanie, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Caroline's job stated by Caroline is direct; the same fact relayed by
Melanie is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Caroline shared
