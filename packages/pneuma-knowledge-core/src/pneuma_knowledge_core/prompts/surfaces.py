...
SURFACES: tuple[Surface, ...] = (
    ...
    Surface(
        ...
        segments=(
            f("steward.consume.library", "Opens the reading reference with the library's mechanisms and what a claim guarantees.",
              "阅读参考的开头，说明知识库的机制以及一条 claim 保证了什么。"),
    ...
    Surface(
        ...
        segments=(
            ...
            f("steward.read.sections", "Names the four primary evidence sections in prose reading order.",
              "按文本阅读顺序列出四个主要证据章节。"),
            f("steward.read.map", "Labels the unchanged glance after the evidence sections.",
              "标记证据章节后原样保留的 glance。"),
            ...
            f("steward.read.queue_empty", "Reports a library with no queued or claimed compile job.",
              "报告全库没有 queued 或 claimed 状态的编译作业。"),
            f("steward.read.queue_pending", "Reports the library's queued and claimed compile count without predicting destination pages.",
              "报告全库 queued 和 claimed 编译作业数，不预测目标页面。"),
