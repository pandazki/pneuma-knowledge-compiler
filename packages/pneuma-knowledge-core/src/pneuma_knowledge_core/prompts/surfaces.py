...
SURFACES: tuple[Surface, ...] = (
    ...
    Surface(
        ...
        segments=(
            ...
            f("steward.episodes.window_task", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
            f("steward.episodes.window", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
            f("steward.episodes.window_empty", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
            f("steward.episodes.window_pending", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
            f("steward.episodes.window_complete", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
            f("steward.episodes.split", "The episodes door: rules, procedure or write-time refusal.", "片段门：规则、流程或写入时拒绝。"),
    ...
    Surface(
        ...
        segments=(
            f("steward.consume.library", "Opens the reading reference: the library's mechanisms, what they establish and what they leave to the reader.",
              "阅读参考的开头：知识库的机制、它确立了什么、什么留给读者判断。"),
            f("steward.consume.when_to_use", "Best practice by the shape of the question: which commands, in what order, and what their headers settle.",
              "按问题的形状给出最佳做法：用哪些命令、什么顺序、头部信息定下了什么。"),
            f("steward.consume.primitives", "The read commands, what each returns and its typical use.",
              "读命令各自返回什么、典型用法。"),
            ...
            f("steward.consume.no_families", "Replaces the family list when no templates are declared.",
              "未声明路径模板时替代族列表。"),
            f("steward.consume.answering", "Closes the reference with the consultation-recording mechanics.",
              "参考结尾说明咨询记录的机制。"),
        ),
        kind=FRAGMENTS,
    ),
    Surface(
        id="steward.cli",
        group="steward",
        title_en="Reader signals and CLI help",
        title_zh="读者信号与 CLI 帮助",
        summary_en="Mechanical reading signals and command descriptions, including references/cli.md.",
        summary_zh="机械阅读信号和命令描述，含 references/cli.md。",
        segments=(
            *(f(key, "Static command or option help in pkc and references/cli.md.",
                "pkc 和 references/cli.md 中的静态命令或选项帮助。") for key in (
                "steward.cli.archive_reason",
                "steward.cli.archive_plan_reason",
                "steward.cli.description",
                "steward.cli.user",
                "steward.cli.draft",
                "steward.cli.draft_description",
                "steward.cli.draft_open",
                "steward.cli.draft_status",
                "steward.cli.draft_check",
                "steward.cli.brief_file",
                "steward.cli.take_over",
                "steward.cli.frontmatter",
                "steward.cli.body_file",
                "steward.cli.claim_file",
                "steward.cli.overview_file",
                "steward.cli.fields_json",
                "steward.cli.page",
                "steward.cli.all_pages",
                "steward.cli.include_archived",
                "steward.cli.evolve_draft",
                "steward.cli.evolve_open",
                "steward.cli.evolve_new",
                "steward.cli.evolve_from",
                "steward.cli.evolve_status",
                "steward.cli.evolve_check",
                "steward.cli.evolve_finish",
                "steward.cli.abandon_draft",
                "steward.cli.evolve_propose",
                "steward.cli.move_claim",
                "steward.cli.rename",
                "steward.cli.retire",
                "steward.cli.evolve_contract",
                "steward.cli.file",
                "steward.cli.stdin",
                "steward.cli.index",
                "steward.cli.episodes",
                "steward.cli.episodes_status",
                "steward.cli.episodes_finish",
                "steward.cli.canonical",
                "steward.cli.paths",
                "steward.cli.anchor",
                "steward.cli.source",
                "steward.cli.title_query",
                "steward.cli.fused",
                "steward.cli.version",
                "steward.cli.evolve",
                "steward.cli.evolve_adopt",
                "steward.cli.recall_query",
                "steward.cli.handoff",
                "steward.cli.visitor_class",
                "steward.cli.as_of",
                "steward.cli.library",
                "steward.cli.owner",
                "steward.cli.statement_file",
                "steward.cli.about",
                "steward.cli.said_at",
                "steward.cli.config",
                "steward.cli.profile",
                "steward.cli.profile_description",
                "steward.cli.profile_file",
                "steward.cli.profile_stdin",
                "steward.cli.payload_file",
                "steward.cli.intake",
                "steward.cli.consult",
                "steward.cli.answer_file",
                "steward.cli.answer_stdin",
                "steward.cli.record_visitor_class",
                "steward.cli.archive",
                "steward.cli.archive_description",
                "steward.cli.archive_document",
                "steward.cli.archive_source",
                "steward.cli.archive_action",
                "steward.cli.cascade",
                "steward.cli.deselect",
                "steward.cli.contract_edit",
                ...
                "steward.cli.jobs_resume",
                "steward.cli.jobs_resume_description",
                "steward.cli.jobs_resume_job",
                "steward.cli.jobs_resume_reason_like",
                "steward.cli.jobs_resume_all",
                "steward.cli.history",
                "steward.cli.brief",
                ...
                "steward.cli.profile_set",
                "steward.cli.profile_confirm",
                "steward.cli.ingest",
                "steward.cli.consult_answer",
                "steward.cli.consult_record",
                "steward.cli.consult_pending",
                "steward.cli.archive_propose",
                "steward.cli.archive_ls",
                "steward.cli.archive_show",
                "steward.cli.archive_confirm",
                "steward.cli.archive_drop",
                "steward.cli.archive_inventory",
                "steward.cli.draft_abandon",
                ...
                "steward.cli.skill",
                "steward.cli.skill_description",
                "steward.cli.skill_install",
                "steward.cli.skill_render",
                "steward.cli.skill_verify",
                "steward.cli.skill_show",
                "steward.cli.skill_probe",
                "steward.cli.json",
                "steward.cli.render_backend",
                "steward.cli.backend",
                "steward.cli.deadline",
                "steward.cli.out",
                "steward.cli.language",
                "steward.cli.force",
                "steward.cli.verify_dir",
                "steward.cli.project",
                "steward.cli.page_chars",
                "steward.cli.profile_field",
                "steward.cli.lexical",
                "steward.cli.semantic",
                "steward.cli.help",
            )),
            f("steward.read.days_owner", "Declares the Owner calendar used for every reader date.",
              "声明所有阅读日期所用的 Owner 时区。"),
            f("steward.read.days_utc", "Declares UTC when no usable Owner timezone is recorded.",
              "未记录可用的 Owner 时区时声明使用 UTC。"),
            f("steward.read.days_default", "Declares the deployment's default calendar when the Owner declared no timezone.",
              "Owner 未声明时区时，声明按本部署默认时区计日。"),
            f("steward.read.compile_jobs", "Counts this tenant's pending and failed compile jobs.",
              "统计当前租户待处理及失败的编译作业。"),
            f("steward.read.index_jobs", "Counts pending and failed index jobs without claiming index completeness.",
              "统计待处理及失败的索引作业，不据此断言索引已完整。"),
            f("steward.cli.recall", "Describes recall's prose ordering and unchanged JSON context in command help and the generated CLI reference.",
              "在命令帮助和生成的 CLI 参考中说明 recall 的文本顺序及原样 JSON 上下文。"),
            f("steward.cli.canonical_read", "Describes canonical page status and the per-span source index in command help.",
              "在命令帮助中描述 canonical 页面状态和逐区间来源索引。"),
            f("steward.cli.search", "Describes ranked hits and lexical counts in search help.",
              "在 search 帮助中描述排名命中与词法计数。"),
            f("steward.cli.source_fetch", "Describes the labelled multi-source span output in source-fetch help.",
              "在 source fetch 帮助中描述带标签的多来源区间输出。"),
            f("steward.cli.source_fetch_spans", "Explains source-fetch span and source-id argument grouping.",
              "说明 source fetch 的区间与来源 id 参数分组。"),
            f("steward.read.imported", "Labels a source date taken from its import timestamp.",
              "标注取自导入时间戳的来源日期。"),
            f("steward.read.section_claims", "Names claims in both the section index and its heading.",
              "统一章节索引与标题中的断言名称。"),
            f("steward.read.section_windows", "Names verbatim windows in both the section index and its heading.",
              "统一章节索引与标题中的原文窗口名称。"),
            f("steward.read.section_episodes", "Names derived episode summaries in both the section index and its heading.",
              "统一章节索引与标题中的派生片段摘要名称。"),
            f("steward.read.section_map", "Names the map in both the section index and its heading.",
              "统一章节索引与标题中的地图名称。"),
            f("steward.read.ranked", "States that this section is rendered by relevance score.",
              "说明此章节按相关性评分排序。"),
            f("steward.read.lane_order", "States that this section preserves the order supplied by the lane.",
              "说明此章节保留 lane 提供的顺序。"),
            f("steward.read.superseded", "Lists predecessors on this page and their repository-wide successor addresses.",
              "列出本页前驱及其在全库中的后继地址。"),
            f("steward.read.this_page", "Labels a successor stored on the page being read.",
              "标注位于当前页面的后继。"),
            f("steward.read.queue", "Combines this tenant’s pending and failed compile counts.",
              "合并当前租户待处理及失败的编译数量。"),
            f("steward.read.compile_pending", "Counts queued and claimed compile jobs.",
              "统计排队及已领取的编译作业。"),
            f("steward.read.compile_failed", "Counts failed compile jobs and names the inspection command.",
              "统计失败的编译作业并给出查看命令。"),
            f("steward.read.pending", "Counts queued and claimed jobs.",
              "统计排队及已领取的作业。"),
            f("steward.read.none_pending", "States that no jobs are pending in the counted scope.",
              "说明统计范围内没有待处理作业。"),
            f("steward.read.none_failed", "States that no jobs failed in the counted scope.",
              "说明统计范围内没有失败作业。"),
            f("steward.read.index_queue", "Reports this tenant’s pending index jobs, the measurable index lag.",
              "报告当前租户待处理的索引作业，即可计数的索引延迟。"),
            f("steward.read.next_page", "Names the exact command to read the next retained evidence page.",
              "给出读取下一页保留证据的精确命令。"),
            f("steward.read.result_end", "Marks the final page and names the command for the entire retained result.",
              "标明最后一页并给出读取完整保留结果的命令。"),
            f("steward.read.new_retrieval", "Distinguishes a new retrieval from paging an existing handoff.",
              "区分新检索与已有交接的分页读取。"),
            f("steward.read.handoff_recorded", "States that the opening is recorded until an answer arrives.",
              "说明开场已记录，尚待追加答案。"),
            f("steward.read.handoff_silent", "States that a silent handoff records no consultation event.",
              "说明 silent 交接不记录任何咨询事件。"),
            f("steward.read.unanswered", "Labels a consultation whose opening has no answer event.",
              "标记只有开场、尚无答案事件的咨询。"),
            f("steward.read.answered", "The state of a consultation whose answer was recorded.", "已记录回答的咨询的状态。"),
            f("steward.read.miss", "The state of an answered consultation that found nothing.", "已作答但什么也没找到的咨询的状态。"),
            f("steward.read.json_paging", "Explains item paging and the whole-result recall JSON exception.",
              "说明按条目分页及 recall JSON 始终完整的例外。"),
            f("steward.read.unknown", "Marks source metadata, commit history or part of a span's authorship that is unavailable.",
              "标记不可用的来源元数据、提交历史或区间内部分发言者。"),
            f("steward.read.none", "Marks an evidence tally with no canonical pages.",
              "标记证据统计中没有 canonical 页面。"),
            f("steward.read.sources", "Opens the source index below recall evidence or a canonical page.",
              "引出 recall 证据或 canonical 页面下方的来源索引。"),
            f("steward.read.cited", "Lists cited spans and their declared speakers beneath one source.",
              "在一个来源下方列出引用区间及其已声明的发言者。"),
            f("steward.read.evidence_for", "Names the question above a recall evidence result.",
              "在 recall 证据结果上方列出问题。"),
            f("steward.read.tally", "Counts the claims, pages, verbatim windows, window sources and derived episodes handed over.",
              "统计交出的断言、页面、原文窗口、窗口来源和派生片段。"),
            f("steward.read.pages", "Lists each evidence page's claim count in first-ranked-appearance order.",
              "按首次排名出现顺序列出每个证据页面的断言数。"),
            f("steward.read.sections", "Names the four primary evidence sections in prose reading order.",
              "按文本阅读顺序列出四个主要证据章节。"),
            f("steward.read.page", "Names a canonical page before its status and body.",
              "在状态和正文之前列出 canonical 页面路径。"),
            f("steward.read.status", "Shows the page's commit date, claim and predecessor counts, cited-source count and latest source day.",
              "显示页面提交日期、断言和前驱数量、引用来源数及最新来源日期。"),
            f("steward.read.query", "Names the search query above its counts and hits.",
              "在计数和命中前列出搜索查询。"),
            f("steward.read.search_counts", "Reports strict all-terms and per-term lexical estimates in lexical and fused search.",
              "在词法和融合搜索中报告严格全部词项及逐词项的词法估计。"),
            f("steward.read.showing", "Reports the displayed lexical hit count against the index's estimated total.",
              "显示词法命中数量及索引估计总数。"),
            f("steward.read.showing_fused", "Reports the fused hit count without inventing an index-wide fused total.",
              "显示融合命中数量，不编造全索引融合总数。"),
            f("steward.read.lexical_total", "Labels the lexical estimate separately from fused result counts.",
              "将词法估计与融合结果数量分开标记。"),
            f("steward.read.showing_semantic", "Reports the displayed semantic hit count without lexical matching claims.",
              "报告显示的语义命中数量，不声称词法匹配。"),
