...
This library holds one long-running two-person conversation: **Jon** and **Gina**, talking
across 19 sessions between 20 January 2023 – 23 July 2023. The material arrives one session at a time and
...
Jon's side of it runs through losing his job as a banker and starting a dance studio, contemporary dance, a crew that took first place in a local competition, rehearsals after work, an upcoming festival performance.
Gina's side runs through losing her Door Dash job, dance as stress relief, competing as a teenager (first place at a regional at fifteen), a contemporary piece called "Finding Freedom".
Recurring named things to expect: the "Finding Freedom" piece; the waterfront studio Jon wants; the festival.
...
**`people/{slug}.md`** — one page per person. Jon and Gina each have one from the start.
...
who they are, how they relate to Jon or Gina, and the facts that belong to *them* — their job,
...
Worth it, in this material: a job ending or starting, with the date it happened; a competition placing with the year and the age; the name of a piece or a venue; a date the two of them agreed to meet; a business step actually taken (a lease looked at, a name chosen).

Not worth it: mutual excitement with no fact attached; repeated "let's do it soon" where no date is set.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about Jon, Gina, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about Jon's job stated by Jon is direct; the same fact relayed by
Gina is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "Jon shared
