...
This library holds one long-running two-person conversation: **John** and **Maria**, talking
across 32 sessions between 17 December 2022 – 16 August 2023. The material arrives one session at a time and
...
John's side of it runs through a run at local politics built on education and infrastructure, kickboxing, family road trips, and the neighbourhood history behind his platform.
Maria's side runs through volunteering at a homeless shelter, aerial yoga and staying fit.
Recurring named things to expect: the school that was renovated after funding; the shelter; the campaign itself.
...
**`people/{slug}.md`** — one page per person. John and Maria each have one from the start.
...
who they are, how they relate to John or Maria, and the facts that belong to *them* — their job,
...
Worth it, in this material: a campaign step and when it happened (who he spoke to, what he committed to); a stated policy focus and the reason he gives for it; a volunteering shift or a fitness milestone with its date; a trip with where and when.

Not worth it: agreement noises; general praise; aspirations restated without a new fact.

The test for anything else: would someone reading this library a year from now need this fact
to answer a question about John, Maria, or someone in their circle? In a chat log the answer is
...
it when it matters: a fact about John's job stated by John is direct; the same fact relayed by
Maria is second-hand and should say so. A plan is not an event — "we'll go next Friday" is an
...
description of what the speaker showed, attributed to the speaker who shared it — "John shared
