...
#: Display names that name nobody. Blank is the scaffold default; `Someone` and `Owner`
#: remain recognized as placeholders in projects generated by earlier versions.
