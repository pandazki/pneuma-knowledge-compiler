...
const en = {
  ...
  searching: 'Searching {name}…', waitToSearch: 'Searches when you pause typing · Enter searches now', answer: 'Search answer', evidence: 'Sources',
  ...
  keyHelp: 'Use the credential name required by your embedding provider.', keySaved: 'Key saved; running engines restarted',
  keySaveFailed: 'Key could not be saved. Check the credential name and try again.',
  keySavedAt: 'saved {time}', keyVerified: 'verified by the running engine',
  keyUnverified: 'stored, not verified — engine is not running',
  keyUnused: 'stored, unused — semantic retrieval is off', replace: 'Replace', cancel: 'Cancel',
...
const zh: Record<keyof typeof en, string> = {
  ...
  searching: '正在搜索 {name}…', waitToSearch: '停顿后开始搜索 · 回车立即搜索', answer: '搜索回答', evidence: '来源',
  ...
  keyHelp: '填写嵌入服务商要求的凭据名称。', keySaved: '密钥已保存，运行中的引擎已重启',
  keySaveFailed: '密钥未能保存。请检查凭据名称后重试。',
  keySavedAt: '已保存 {time}', keyVerified: '引擎已验证',
  keyUnverified: '引擎未运行，尚未验证',
  keyUnused: '语义检索已关闭，未使用', replace: '替换', cancel: '取消',
