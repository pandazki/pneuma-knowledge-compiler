...
A fictional project's release-planning fragment is ingested twice: once as generic
...
U_BASE = UserId("u-context-base")
U_CONV = UserId("u-context-first-party")
...
def show_prompt() -> int:
    ...
    raw = RawSource(
        source_id=SourceId("context-demo"), user_id=UserId("u-context-demo"),
    ...
    print(_render_task([norm], [], treatments={"context-demo": "full"},
                       source_guidance={"context-demo": ct.compile_guidance().render()}))
    return 0
