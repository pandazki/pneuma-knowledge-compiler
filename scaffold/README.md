...
```
my-kb/
  contract.md        # YOURS — the compile contract (what deserves memory, on which page)
  profile.yaml       # YOURS — the owner profile
  .env               # YOURS — key, models, auto-probed ports (gitignored)
...
`contract.md`. The full practice of writing one — type → implied-usage derivation, subject
