...
const en = {
  ...
  start: 'Start', stop: 'Stop', restart: 'Restart service', syncNow: 'Import new content', syncing: 'Syncing…',
  continueTasks: 'Continue now ({count})', continued: '{count} tasks returned to the queue',
  continueHelp: 'After fixing the quota, login or connection, retry waiting and paused tasks now.',
  syncHelp: 'Scan watched directories and import new sessions or changes.',
  restartHelp: 'Restart all library services. Scheduled retry times are kept.',
  waitingCount: '{count} waiting to retry', pausedCount: '{count} paused', nextRetry: 'Next retry: {time}',
  manualCompile: 'Unattended compilation is off; enable it in Settings to process compiled tasks automatically.',
...
const zh: Record<keyof typeof en, string> = {
  ...
  start: '启动服务', stop: '停止服务', restart: '重启服务', syncNow: '导入新内容', syncing: '同步中…',
  continueTasks: '立即继续（{count}）', continued: '已将 {count} 个任务放回处理队列',
  continueHelp: '额度、登录或网络恢复后，可立即重试等待中和已暂停的任务。',
  syncHelp: '扫描监看目录，导入新增会话和内容变更。',
  restartHelp: '重新启动所有知识库的服务；任务的重试时间会保留。',
  waitingCount: '{count} 个等待重试', pausedCount: '{count} 个已暂停', nextRetry: '下次重试：{time}',
  manualCompile: '无人值守编译已关闭；如需自动处理编译任务，请在设置中开启。',
